{include file="$template/irnic_handle_header.tpl"}
	 ...
	 <input name="handle_class" value="Organization" type="hidden">
	...
	<td>	 
      <table width="100%" border="0" cellpadding="10" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="2" class="fieldarea">نام وزارت‌خانه یا سازمان:<span class="mandatory">*</span></td>
            <td><input name="org" class="" tabindex="7" size="40" type="text">
              <div class="example">مثال: <span dir="ltr">Ministry of Science, Research and Technology</span></div></td>
          </tr>
          <tr>
            <td rowspan="2" class="fieldarea">مدیر:</td>
          ...
          <tr>
            <td colspan="2" class="fieldarea">نوع سازمان:<span class="mandatory">*</span></td>
            <td><select name="gov_catsub" id="gov_catsub" class="" style="text-align: right; direction: rtl;" tabindex="13">
              <option value="" label="لطفا انتخاب کنید..." class="lang_fa" dir="rtl" align="right" selected="selected" lang="fa">لطفا انتخاب کنید...</option>
              <option value="Leader__Any" label="نهاد رهبری">نهاد رهبری</option>
              <option value="Judiciary__Any" label="قوه قضائیه">قوه قضائیه</option>
              <option value="Legislative__Any" label="قوه مقننه">قوه مقننه</option>
              <option value="Executive__Ministry" label="وزارتخانه">وزارتخانه</option>
              <option value="Executive__Company" label="شرکت دولتی">شرکت دولتی</option>
              <option value="Executive__Organization" label="سازمان">سازمان</option>
              <option value="Executive__President" label="نهاد وابسته به ریاست جمهوری">نهاد وابسته به ریاست جمهوری</option>
              <option value="Executive__Province" label="استانداری یا فرمانداری">استانداری یا فرمانداری</option>
              <option value="Executive__Municipality" label="شهرداری">شهرداری</option>
            </select></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">استان:<span class="mandatory">*</span></td>
            <td><input name="gov_state" class="" tabindex="14" type="text">
              <div class="example">مثال: <span dir="ltr">Tehran</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">شهر:<span class="mandatory">*</span></td>
            <td><input name="gov_city" class="" tabindex="15" type="text">
              <div class="example">مثال: <span dir="ltr">Tehran</span></div></td>
          </tr>
          <tr>
            <td colspan="3"></td>
