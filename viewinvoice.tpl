        ...
        {else}
            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    {if $logo}
                        <p><img src="assets/img/logo.png" title="{$companyname}" /></p>
                    {else}
                        <h2>{$companyname}</h2>
                    {/if}
                    <h3>{$pagetitle}</h3>
            ...
            <div class="row">
                <div class="col-sm-6 pull-sm-left text-left-sm">
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                {/foreach}
                                <tr>
                                    <td class="total-row text-left"><strong>{$LANG.invoicessubtotal}</strong></td>
                                    <td class="total-row text-center">{$subtotal}</td>
                                </tr>
                                {if $taxrate}
                                    <tr>
                                        <td class="total-row text-left"><strong>{$taxrate}% {$taxname}</strong></td>
                                        <td class="total-row text-center">{$tax}</td>
                                    </tr>
                                {/if}
                                {if $taxrate2}
                                    <tr>
                                        <td class="total-row text-left"><strong>{$taxrate2}% {$taxname2}</strong></td>
                                        <td class="total-row text-center">{$tax2}</td>
                                    </tr>
                                {/if}
                                <tr>
                                    <td class="total-row text-left"><strong>{$LANG.invoicescredit}</strong></td>
                ...
                <div class="table-responsive">
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            {/foreach}
                            <tr>
                                <td class="text-left" colspan="3"><strong>{$LANG.invoicesbalance}</strong></td>
