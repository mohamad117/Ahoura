...
<div class="landing-page ssl">
    ...
    <div class="content-block">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4 col-md-3 col-sm-push-8 col-md-push-9 text-left hidden-xs">
                    <br><br>
...
$(function() {
  $(".expand").on( "click", function() {
    ...
    if($expand.html() == '<i class="fa fa-chevron-left"></i>') {
      $expand.html('<i class="fa fa-chevron-down"></i>');
    } else {
      $expand.html('<i class="fa fa-chevron-left"></i>');
    }
  });
