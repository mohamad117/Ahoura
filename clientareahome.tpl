<div class="tiles clearfix">
    <div class="row">
        <div class="col-sm-3 col-xs-12 tile" onclick="window.location='clientarea.php?action=services'">
        ...
        {if $registerdomainenabled || $transferdomainenabled}
            <div class="col-sm-3 col-xs-12 tile" onclick="window.location='clientarea.php?action=domains'">
        ...
        {elseif $condlinks.affiliates && $clientsstats.isAffiliate}
            <div class="col-sm-3 col-xs-12 tile" onclick="window.location='affiliates.php'">
        ...
        {else}
            <div class="col-sm-3 col-xs-12 tile" onclick="window.location='clientarea.php?action=quotes'">
        ...
        {/if}
        <div class="col-sm-3 col-xs-12 tile" onclick="window.location='supporttickets.php'">
        ...
        <div class="col-sm-3 col-xs-12 tile" onclick="window.location='clientarea.php?action=invoices'">
                ...
                <div menuItemName="{$item->getName()}" class="panel panel-default panel-accent-{$item->getExtra('color')}{if $item->getClass()} {$item->getClass()}{/if}"{if $item->getAttribute('id')} id="{$item->getAttribute('id')}"{/if}>
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            {/if}
                            {if $item->hasIcon()}<i class="fa fa-ticket"></i>&nbsp;{/if}
                            {$item->getLabel()}
