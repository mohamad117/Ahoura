{include file="$template/irnic_handle_header.tpl"}
	 ...
	 <input name="handle_class" value="Company" type="hidden">
        ...
        <tbody>
          <tr>
            <td colspan="3"><table class="admonition" style="width: 100%;">
              <tbody>
                <tr>
                  <td class="notice" width="5%"><img src="templates/{$template}/images/gif.png" alt=""></td>
                  <td><ul>
                    <li class="myli">خواهشمند است اطلاعات خواسته شده در فرم زیر را دقیق و مطابق با اطلاعات مثبِت وارد نمایید.</li>
                    <li>جهت کسب اطلاعات بیشتر، <a href="https://www.nic.ir/applications/IRNIC_Handle_Terms_and_Conditions.pdf">ضوابط و شرایط شناسه ایرنیک</a> را پیش از پرکردن اطلاعات مطالعه نمایید.</li>
                  </ul></td>
                </tr>
              </tbody>
            </table>
          ...
          <tr>
            <td colspan="2" class="fieldarea">نام شرکت یا سازمان:<span class="mandatory">*</span></td>
            <td><input name="org" class="" tabindex="7" size="40" type="text">
              <div class="example">مثال: <span dir="ltr">Iran Example Co.</span></div></td>
          </tr>
          <tr>
            <td rowspan="2" class="fieldarea">مدیر عامل یا مدیر سازمان:</td>
          ...
          <tr>
            ...
            <td><select name="private_country" id="private_country" class="" style="text-align: left; direction: ltr;" tabindex="13">
              <option value="" label="لطفا انتخاب کنید..." class="lang_fa"  selected="selected" lang="fa">لطفا انتخاب کنید...</option>
          ...
          <tr>
            <td colspan="2" class="fieldarea">استان ثبتی:<span class="mandatory">*</span></td>
            <td><input name="private_state" class="" tabindex="14" type="text">
              <div class="example">مثال: <span dir="ltr">Tehran</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">واحد ثبتی:<span class="mandatory">*</span></td>
            <td><input name="private_issuer" class="" tabindex="15" type="text">
              <div class="example">مثال: <span dir="ltr">Tehran</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">شماره ثبت:<span class="mandatory">*</span></td>
            <td><input name="private_no" class="" tabindex="16" type="text">
              <div class="example">مثال: <span dir="ltr">1234</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">نوع ثبت:<span class="mandatory">*</span></td>
            <td><select name="private_catsub" id="private_catsub" class="" style="text-align: right; direction: rtl;" tabindex="17">
              <option value="" label="لطفا انتخاب کنید..." class="lang_fa" dir="rtl" align="right" selected="selected" lang="fa">لطفا انتخاب کنید...</option>
              <option value="SabtSherkat__PublicCompany" label="شرکت سهامی عام">شرکت سهامی عام</option>
              <option value="SabtSherkat__PrivateCompany" label="شرکت سهامی خاص">شرکت سهامی خاص</option>
              <option value="SabtSherkat__LimitedCompany" label="شرکت با مسئولیت محدود">شرکت با مسئولیت محدود</option>
              <option value="SabtSherkat__CooperativeCompany" label="شرکت تعاونی">شرکت تعاونی</option>
              <option value="SabtSherkat__Organization" label="موسسه">موسسه</option>
              <option value="Ershad__Any" label="انتشارات و نشریات">انتشارات و نشریات</option>
            </select></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">شناسه ملی (ایران):</td>
            <td><input name="private_no2" class="" tabindex="18" type="text">
              <div class="example">مثال: <span dir="ltr">12345678901</span></div></td>
          </tr>
          <tr>
            <td colspan="3"></td>
          </tr>
            ...
            <td colspan="3"><table class="admonition" style="width: 100%;">
              <tbody>
                <tr>
                  <td class="notice" width="5%"><img src="templates/{$template}/images/gif.png" alt=""></td>
                  <td><ul><br>
                    <li class="centerli">نشانی ارایه شده توسط متقاضی دریافت شناسه کاربری باید صحیح و منطبق با واقع باشد.</li>
                    <li>توجه
                    ...
                    <li>ارائه? صندوق پستی به عنوان نشانی پستی قابل قبول نمی‌باشد.</li>
                  </ul></td>
                </tr>
              </tbody>
            </table>
          ...
          <tr>
            <td colspan="2" class="fieldarea">کشور:<span class="mandatory">*</span></td>
            <td><select name="country" id="country" class="" style="text-align: left; direction: ltr;" tabindex="19">
          ...
          <tr>
            ...
            <td><input name="state" class="" tabindex="20" type="text">
              <div class="example">مثال: <span dir="ltr">Tehran</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">شهر:<span class="mandatory">*</span></td>
            <td><input name="city" class="" tabindex="21" type="text">
              <div class="example">مثال: <span dir="ltr">Tehran</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">نشانی:<span class="mandatory">*</span></td>
            <td><textarea name="address" cols="90" rows="7" class="" tabindex="22"></textarea>
          ...
          <tr>
            ...
            <td><input name="postcode" class="" tabindex="23" type="text">
