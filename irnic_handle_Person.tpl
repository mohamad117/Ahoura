{include file="$template/irnic_handle_header.tpl"}
	 ...
	 <input name="handle_class" value="Person" type="hidden">
	...
	<td>
      ...
      <table width="100%" border="0" cellpadding="10" cellspacing="0">
        ...
        <tbody>
          <tr>
            <td colspan="3">
			<table class="admonition" style="width: 100%;">
              <tbody>
                <tr>
          ...
          <tr>
            <td colspan="3"><h3>نام شخص و سازمان (لاتین)</h3></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" class="fieldarea">نام:<span class="mandatory">*</span></td>
            <td><input name="firstname" class="" tabindex="7" size="40" type="text">
              <div class="example">مثال: <span dir="ltr">AliReza</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">نام خانوادگی:<span class="mandatory">*</span></td>
            <td><input name="lastname" class="" tabindex="8" size="40" type="text">
              <div class="example">مثال: <span dir="ltr">Mohammadi</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">سازمان:</td>
            <td><input name="org" class="" tabindex="9" size="40" type="text">
          ...
          <tr>
            <td colspan="3"><h3>اطلاعات احراز هویت<span class="mandatory">*</span></h3></td>
          </tr>
          <tr>
            <td colspan="3"><table class="admonition" style="width: 100%;">
              <tbody>
                <tr>
                  <td class="notice" width="5%"><img src="templates/{$template}/images/note.gif" alt=""></td>
                  <td><ul>
                    <li>تکمیل شمارهٔ ملی یا گذرنامه به تنهایی کافی است و ارایهٔ هر دو این
                      اطلاعات ضروری نیست. توجه داشته باشید در صورت ارایهٔ شمارهٔ گذرنامه پر 
                      کردن کلیهٔ اطلاعات خواسته شده در مورد آن ضروری است.</li>
          ...
          <tr>
            <td colspan="2" class="fieldarea">کد ملی (ایران):</td>
            <td><input name="idcard_no" class="" tabindex="13" type="text">
              <div class="example">مثال: <span dir="ltr">123-456789-0</span></div></td>
          </tr>
          <tr>
            
            <td colspan="2" class="fieldarea">کشور:</td>
            <td><select name="passport_country" id="passport_country" class="" style="text-align: left; direction: ltr;" tabindex="14">
          ...
          <tr>
            <td colspan="2" class="fieldarea">شماره گذرنامه :</td>
            <td><input name="passport_no" class="" tabindex="15" type="text">
              <div class="example">مثال: <span dir="ltr">H123456</span></div></td>
          </tr>
          <tr>
            <td colspan="2" class="fieldarea">صادرکننده:</td>
            <td><input name="passport_issuer" class="" tabindex="16" type="text">
              <div class="example">مثال: <span dir="ltr">Naja Passport Office</span></div></td>
          </tr>
          <tr>
            <td colspan="3"></td>
          </tr>
          ...
          <tr>
            ...
            <td><select name="country" id="country" class="" style="text-align: left; direction: ltr;" tabindex="17">
          ...
          <tr>
            ...
            <td><input name="postcode" class="" tabindex="21" type="text">
