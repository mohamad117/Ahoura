        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    ...
                    <p>The easy drag & drop builder allows you to create a professional website with no technical skills required. Choose different elements to add photos, maps or videos by just dragging and dropping them into place, left from your web browser.</p>
                </div>
            </div>
        </div>
    </div>
